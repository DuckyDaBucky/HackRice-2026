    ...
    <div className={styles.layout}>
      ...
      <div className={styles.workspace}>
        ...
        <div hidden={mode!=="Interview"}>
          ...
          <p>Your reviewed profile and selected role are included by default. Experience comes from parsing unless you choose a target level. Relevant questions vary between packs; recent topics are avoided within this session.</p>
